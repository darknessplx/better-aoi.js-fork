...
module.exports = async () => {
    try {
        const res = await fetch("https://registry.npmjs.org/better-aoi.js-fork", {
            ...
            headers: {
                "User-Agent": "better-aoi.js-fork" // required by npm registry API
            }
        });
        ...
        if (!isDevVersion && json.version !== latestVersion) {
            AoiError.createConsoleMessage([{ text: 'Outdated version detected, update with "npm install better-aoi.js-fork@latest"', textColor: "red" }], "white", { text: "AoiWarning", textColor: "yellow" });
